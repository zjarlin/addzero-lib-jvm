...
//import com.addzero.component.table.biz.*
...
//
//
//    val tableViewModel = AddCleanTableViewModel<BigDataModel>(
//        data = bigDataSet,
//        columns = TODO(),
//        getIdFun = {it.field001+it.field002},
//        baseCrudApi = null,
//    ).apply {
//        buttonSlot = {
//            RenderCheckbox()
...
//            Text(
//                text = config.columnMetadata.comment,
...
//                RenderSort(config, { it.columnMetadata.columnName })
//            }
//        },
//        config = TableConfig(),
//        slots = tableSlots,
