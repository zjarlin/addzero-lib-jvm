...
import com.addzero.entity.low_table.StateSearch
    ...
    class TableFilterViewModel<C>(private val getColumnKey: (C) -> String, columnConfigs: List<ColumnConfig>) : ViewModel() {
    ...
    fun getCurrentColumnKey(): String = if (_currentClickColumn == null) "" else getColumnKey(_currentClickColumn!!).ifBlank {
