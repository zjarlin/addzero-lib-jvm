...
object RouteTable {
     ...
     */
    val allRoutes = mapOf(
        RouteKeys.RICH_TEXT_DEMO to  @Composable { com.addzero.component_demo.RichTextDemo() },
        RouteKeys.ADD_CARD_EXAMPLE to  @Composable { com.addzero.component_demo.AddCardExample() },
        RouteKeys.U_I_COMPONENTS_DEMO to  @Composable { com.addzero.component_demo.UIComponentsDemo() },
        RouteKeys.LARGE_TABLE_TEST_SCREEN to  @Composable { com.addzero.component_demo.clean_table.LargeTableTestScreen() },
        RouteKeys.TABLE_ORIGINAL_DEBUG_TEST to  @Composable { com.addzero.component_demo.TableOriginalDebugTest() },
        RouteKeys.TIME_PICKER_EXAMPLE to  @Composable { com.addzero.component_demo.date_test.TimePickerExample() },
        RouteKeys.TIME_PICKER_FIELD_TEST to  @Composable { com.addzero.component_demo.date_test.TimePickerFieldTest() },
        RouteKeys.DATE_PICKER_FIELD_TEST to  @Composable { com.addzero.component_demo.date_test.DatePickerFieldTest() },
        RouteKeys.DATE_TIME_PICKER_EXAMPLE to  @Composable { com.addzero.component_demo.date_test.DateTimePickerExample() },
        RouteKeys.DATE_RANGE_PICKER_FIELD_TEST to  @Composable { com.addzero.component_demo.date_test.DateRangePickerFieldTest() },
        RouteKeys.SYS_ICON_SCREEN to  @Composable { com.addzero.component_demo.icon.SysIconScreen() },
        RouteKeys.WE_CHAT_ICON to  @Composable { com.addzero.component_demo.icon.WeChatIcon() },
        RouteKeys.DRAG_LIST_DEMO to  @Composable { com.addzero.component_demo.DragListDemo() },
        RouteKeys.TEST_PICKER to  @Composable { com.addzero.component_demo.upload.TestPicker() },
        RouteKeys.UPLOAD_MANAGER_DEMO to  @Composable { com.addzero.component_demo.upload.UploadManagerDemo() },
        RouteKeys.TEST_DIRECTORY_PICKER to  @Composable { com.addzero.component_demo.upload.TestDirectoryPicker() },
        RouteKeys.IMAGE_LOAD to  @Composable { com.addzero.component_demo.ImageLoad() },
        ...
        RouteKeys.TABS_EXAMPLE_SCREEN to  @Composable { com.addzero.component_demo.TabsExampleScreen() },
     ...
     */
    val allMeta = listOf(
        Route(value = "组件示例", title = "富文本", routePath = "com.addzero.component_demo.RichTextDemo", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.RichTextDemo"),
        Route(value = "", title = "AddCardExample", routePath = "com.addzero.component_demo.AddCardExample", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.AddCardExample"),
        Route(value = "组件示例", title = "UI组件测试", routePath = "com.addzero.component_demo.UIComponentsDemo", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.UIComponentsDemo"),
        Route(value = "", title = "LargeTableTestScreen", routePath = "com.addzero.component_demo.clean_table.LargeTableTestScreen", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.clean_table.LargeTableTestScreen"),
        Route(value = "", title = "TableOriginalDebugTest", routePath = "com.addzero.component_demo.TableOriginalDebugTest", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.TableOriginalDebugTest"),
        Route(value = "时间选择器示例", title = "TimePickerExample", routePath = "com.addzero.component_demo.date_test.TimePickerExample", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.date_test.TimePickerExample"),
        Route(value = "组件示例", title = "时间选择器", routePath = "com.addzero.component_demo.date_test.TimePickerFieldTest", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.date_test.TimePickerFieldTest"),
        Route(value = "组件示例", title = "日期选择器", routePath = "com.addzero.component_demo.date_test.DatePickerFieldTest", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.date_test.DatePickerFieldTest"),
        Route(value = "组件示例", title = "日期时间选择器示例", routePath = "com.addzero.component_demo.date_test.DateTimePickerExample", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.date_test.DateTimePickerExample"),
        Route(value = "组件示例", title = "日期范围选择器", routePath = "com.addzero.component_demo.date_test.DateRangePickerFieldTest", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.date_test.DateRangePickerFieldTest"),
        Route(value = "组件示例", title = "M3图标树", routePath = "com.addzero.component_demo.icon.SysIconScreen", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.icon.SysIconScreen"),
        Route(value = "组件示例", title = "微信图标", routePath = "/component/wechatIcon", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.icon.WeChatIcon"),
        Route(value = "组件示例", title = "拖拽列表", routePath = "com.addzero.component_demo.DragListDemo", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.DragListDemo"),
        Route(value = "组件示例", title = "文件选择器", routePath = "com.addzero.component_demo.upload.TestPicker", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.upload.TestPicker"),
        Route(value = "组件示例", title = "上传管理器", routePath = "com.addzero.component_demo.upload.UploadManagerDemo", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.upload.UploadManagerDemo"),
        Route(value = "组件示例", title = "文件夹选择器", routePath = "com.addzero.component_demo.upload.TestDirectoryPicker", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.upload.TestDirectoryPicker"),
        Route(value = "组件示例", title = "图片加载", routePath = "com.addzero.component_demo.ImageLoad", icon = "", order = 0.0, qualifiedName = "com.addzero.component_demo.ImageLoad"),
        ...
        Route(value = "组件示例", title = "多标签页组件", routePath = "examples/tabs", icon = "Sharp", order = 3.0, qualifiedName = "com.addzero.component_demo.TabsExampleScreen"),
