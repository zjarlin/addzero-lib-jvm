package site.addzero.web.infra.db_backup
...
class DatabaseBackupService {
    ...
    fun backupDatabase() {
        try {
            ...
            val resource = resolver.getResource("classpath:" + packagePath + "/scripts/" + BACKUP_DM_DB + ".sh")

            // 创建临时文件并将脚本内容复制到临时文件
            val tempScript = Files.createTempFile(BACKUP_DM_DB, ".sh")
            Files.copy(
