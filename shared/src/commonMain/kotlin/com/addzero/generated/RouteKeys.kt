 ...
 */
object RouteKeys {
    const val SELECT_DEMO2 = "/component/select2"
     ...
     */
    val allMeta = listOf(
        Route(value = "组件示例", title = "Select选择框2", routePath = "/component/select2", icon = "", order = 0.0, qualifiedName = "com.addzero.demo.SelectDemo2"),
        ...
        Route(value = "组件示例", title = "Select选择框", routePath = "/component/select", icon = "", order = 0.0, qualifiedName = "com.addzero.demo.SelectDemo"),
