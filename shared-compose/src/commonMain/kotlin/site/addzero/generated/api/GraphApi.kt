...
/**
 * Ktorfit接口 - 由KSP自动生成
 * 原始Controller: site.addzero.ai.graphrag.controller.GraphController
 * 基础路径: /graph
 */
interface GraphApi {
 ...
 * 返回类型: kotlin.collections.List<site.addzero.entity.graph.entity.GraphPO>
 */
    @POST("/graphextractGraphFile")    suspend fun createGraph(
        @Query("modelName") modelName: kotlin.String,
        @Query("file") file: io.ktor.client.request.forms.MultiPartFormDataContent
    ): kotlin.collections.List<site.addzero.entity.graph.entity.GraphPO>
