...
/**
 * Ktorfit接口 - 由KSP自动生成
 * 原始Controller: site.addzero.web.modules.controller.SysMenuController
 * 基础路径: /sysMenu
 */
 ...
 * 返回类型: kotlin.collections.Map<kotlin.String, site.addzero.entity.sys.menu.SysMenuVO>
 */
    @POST("/sysMenu/getSysMenu")    suspend fun getAllMenu(
        @Body params: kotlin.collections.Set<kotlin.String>
    ): kotlin.collections.Map<kotlin.String, site.addzero.entity.sys.menu.SysMenuVO>
