...
/**
 * Ktorfit接口 - 由KSP自动生成
 * 原始Controller: site.addzero.web.modules.controller.SysRoleController
 * 基础路径: /sysRole
 */
 ...
 * 返回类型: kotlin.collections.List<site.addzero.generated.isomorphic.SysRoleIso>
 */
    @GET("/sysRole/tree")    suspend fun tree(
        @Query("keyword") keyword: kotlin.String
    ): kotlin.collections.List<site.addzero.generated.isomorphic.SysRoleIso>
