...
/**
 * Ktorfit接口 - 由KSP自动生成
 * 原始Controller: site.addzero.web.modules.controller.SysFavoriteTabController
 * 基础路径: /sysFavoriteTab
 */
 ...
 * 参数:
 *   - sysFavoriteTab: site.addzero.generated.isomorphic.SysFavoriteTabIso (RequestBody)
 * 返回类型: kotlin.Boolean
 */
    @POST("/sysFavoriteTab/add")    suspend fun add(
        @Body sysFavoriteTab: site.addzero.generated.isomorphic.SysFavoriteTabIso
    ): kotlin.Boolean
