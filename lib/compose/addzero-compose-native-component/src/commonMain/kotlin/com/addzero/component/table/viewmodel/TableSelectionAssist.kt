...
// * 是否有选中项目
// */
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) val hasSelection: Boolean
//    get() {
//        return addCleanTableViewModel._selectedItemIds.isNotEmpty()
//    }
//
//
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) val selectedCount: Int
//    get() {
...
// * 切换编辑模式
// */
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) fun toggleEditMode() {
...
// * 设置编辑模式
// */
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) fun setEditMode(enabled: Boolean) {
...
// * 选中当前页所有项目
// */
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) fun selectPageItems(pageIds: List<Any>) {
...
// * 取消选中当前页所有项目
// */
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) fun unselectPageItems(
//    pageIds: List<Any>
//) {
//    addCleanTableViewModel._selectedItemIds = addCleanTableViewModel._selectedItemIds.filter { it !in pageIds }.toSet()
//}
//
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) fun isPageAllSelected(
//    pageIds: List<Any>
//): Boolean {
...
// * 清空所有选择
// */
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) fun clearSelection() {
//    addCleanTableViewModel._selectedItemIds = emptySet()
...
// * 选中指定项目
// */
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) fun selectItems(itemIds: Set<Any>) {
...
// * 取消选中指定项目
// */
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) fun unselectItems(itemIds: Set<Any>) {
...
// * 判断项目是否被选中
// */
//context(addCleanTableViewModel: AddCleanTableViewModel<*>) fun isItemSelected(itemId: Any): Boolean {
