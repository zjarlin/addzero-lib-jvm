...
@Composable
context(tableViewModel: com.addzero.kmp.component.table.clean.AddCleanTableViewModel<T>, horizontalScrollState: ScrollState) fun <T> TableRow(
    item: T, onRowClick: ((T) -> Unit)?, rowCusTomRender: @Composable com.addzero.kmp.component.table.model.AddCleanColumn<T>.(T) -> Unit, index: Int, leftSloat: @Composable () -> Unit = {}, rightSloat: @Composable () -> Unit = {}
) {
