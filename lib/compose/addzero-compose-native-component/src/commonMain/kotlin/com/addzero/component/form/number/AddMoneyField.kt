package com.addzero.component.form.number
...
fun AddMoneyField(
    ...
    val finalLeadingIcon = leadingIcon ?: _root_ide_package_.com.addzero.component.form.number.getCurrencyIcon(currency)
    _root_ide_package_.com.addzero.component.form.text.AddTextField(
        value = value,
        onValueChange = { newValue ->
            // 过滤输入，只允许数字和小数点（金额通常不允许负数）
            val filteredValue = _root_ide_package_.com.addzero.component.form.number.filterDecimalInput(newValue, allowNegative = false)
