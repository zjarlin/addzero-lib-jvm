package com.addzero.component.flattree

import androidx.compose.runtime.Composable
import androidx.compose.runtime.LaunchedEffect
import androidx.compose.ui.Modifier
import com.addzero.component.tree.AddTree
import com.addzero.component.tree.NodeType
...
data class TreeNode<T>(
    val id: Any,
    val name: String,
    val nodeType: String = _root_ide_package_.com.addzero.component.tree.NodeType.DEFAULT.toString(),
    val data: T,
    val parentId: Any? = null,
    var children: List<com.addzero.component.flattree.TreeNode<T>> = emptyList()
)
...
fun <T> AddFlatTree(
    ...
    getName: (T) -> String,
    getNodeType: (T) -> String = { _root_ide_package_.com.addzero.component.tree.NodeType.DEFAULT.toString() },
    ...
    val treeNodes = items.map { item ->
        _root_ide_package_.com.addzero.component.flattree.TreeNode(
            id = getId(item),
            name = getName(item),
...
//    )
    ...
    val viewModel = _root_ide_package_.com.addzero.component.tree.rememberTreeViewModel<com.addzero.component.flattree.TreeNode<T>>()
