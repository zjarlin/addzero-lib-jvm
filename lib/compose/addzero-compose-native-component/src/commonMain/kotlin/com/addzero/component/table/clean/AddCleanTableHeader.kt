 ...
 */
@Composable
context(tableHeaderScope: com.addzero.component.table.clean.TableHeaderScope<C>)
fun <C> AddCleanTableHeader() {
    ...
    Row(
        ...
        _root_ide_package_.com.addzero.component.table.clean.FixedColumn(tableHeaderScope.renderCheckbox)
        ...
        Row(
            ...
            tableHeaderScope.columns.forEach { column ->
                _root_ide_package_.com.addzero.component.table.clean.HeaderColumn(
                    column = column,
