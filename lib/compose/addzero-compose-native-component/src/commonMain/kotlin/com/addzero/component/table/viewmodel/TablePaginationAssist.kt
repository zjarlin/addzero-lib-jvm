...
//context(addCleanTableViewModel: com.addzero.component.table.clean.AddCleanTableViewModel<*>)
//fun resetPagination() {
//    addCleanTableViewModel._pageState = _root_ide_package_.com.addzero.component.table.viewmodel.StatePagination()
//}
//
///**
// * 获取当前页的起始条目索引（从0开始）
...
//context(addCleanTableViewModel: com.addzero.component.table.clean.AddCleanTableViewModel<*>)
//val endIndex: Int
//    get() = minOf(_root_ide_package_.com.addzero.component.table.viewmodel.startIndex + addCleanTableViewModel._pageState.pageSize, addCleanTableViewModel._pageState.totalItems)
//
///**
// * 是否显示分页控件
// */
