...
fun AddEmailField(
    ...
    var selectedSuffix by remember(value) {
        ...
        val match = _root_ide_package_.com.addzero.component.form.text.commonEmailSuffixes.find { it.removePrefix("@") == suffix }
        mutableStateOf(match ?: _root_ide_package_.com.addzero.component.form.text.commonEmailSuffixes[0])
    }
...
//            )
            ...
            ExposedDropdownMenu(
                ...
                _root_ide_package_.com.addzero.component.form.text.commonEmailSuffixes.forEach { suffix ->
