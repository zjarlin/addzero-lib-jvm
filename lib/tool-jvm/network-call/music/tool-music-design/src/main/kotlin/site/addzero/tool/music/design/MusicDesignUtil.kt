...
import site.addzero.network.call.suno.SunoUtil
...
object MusicDesignUtil {
    ...
    fun remixBySongName(
        ...
        // 生成音乐
        return SunoUtil.generateMusicCustom(
            lyrics = cleanLyrics,
            title = songName,
            tags = tags,
            model = model
    ...
    fun remixBySongNameAndWait(
        ...
        return SunoUtil.waitForCompletion(taskId, maxWaitTimeSeconds)
    }
    ...
    fun batchRemixBySongNamesAndWait(
        ...
        return SunoUtil.waitForBatchCompletion(taskIds, maxWaitTimeSeconds)
    }
