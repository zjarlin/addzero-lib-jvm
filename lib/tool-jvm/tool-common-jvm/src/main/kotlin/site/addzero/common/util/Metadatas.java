package site.addzero.common.util;//package site.addzero.common.util;
//
...
//                String uri = uri(requestMapping.columnValue(), requestMapping.path());
//                if (uri != null) {
//                    return uri;
//                }
//            }
...
//            if (getMapping != null) {
//                String uri = uri(getMapping.columnValue(), getMapping.path());
//                if (uri != null) {
//                    return uri;
//                }
//            }
...
//            if (postMapping != null) {
//                String uri = uri(postMapping.columnValue(), postMapping.path());
//                if (uri != null) {
//                    return uri;
//                }
//            }
...
//            if (putMapping != null) {
//                String uri = uri(putMapping.columnValue(), putMapping.path());
//                if (uri != null) {
//                    return uri;
//                }
//            }
...
//                String uri = uri(deleteMapping.columnValue(), deleteMapping.path());
//                if (uri != null) {
//                    return uri;
//                }
//            }
...
//                String uri = uri(patchMapping.columnValue(), patchMapping.path());
//                if (uri != null) {
//                    return uri;
//                }
//            }
...
//        }
//
//        private static String uri(String[] columnValue, String[] path) {
//            for (String uri : columnValue) {
//                if (!uri.isEmpty()) {
//                    return uri;
//                }
//            }
...
//                return null;
//            }
//            String name = requestHeader.columnValue();
//            if (name.isEmpty()) {
...
//                return null;
//            }
//            String name = requestParam.columnValue();
//            if (name.isEmpty()) {
...
//                return null;
//            }
//            String name = pathVariable.columnValue();
//            if (name.isEmpty()) {
...
//                return null;
//            }
//            String name = requestPart.columnValue();
//            if (name.isEmpty()) {
...
//            Class<?> jdbcType = javaParameter.getJdbcType();
//            return jdbcType == MultipartFile.class || jdbcType == MultipartFile[].class;
//        }
//    }
//}
