...
data class ModifyThreadRequestToolResources(
    ...
    val codeInterpreter: site.addzero.api.openai.models.ModifyThreadRequestToolResourcesCodeInterpreter? = null,
    @SerialName("file_search")
    val fileSearch: site.addzero.api.openai.models.ModifyThreadRequestToolResourcesFileSearch? = null
)
