...
interface OpenAiChatApi {
     ...
     */
    @GET(OpenAiApiPaths.CHAT_BY_COMPLETIONS)
     ...
     */
    @POST(OpenAiApiPaths.CHAT_BY_COMPLETIONS)
     ...
     */
    @DELETE(OpenAiApiPaths.CHAT_BY_COMPLETIONS_BY_COMPLETION_ID)
     ...
     */
    @GET(OpenAiApiPaths.CHAT_BY_COMPLETIONS_BY_COMPLETION_ID)
     ...
     */
    @POST(OpenAiApiPaths.CHAT_BY_COMPLETIONS_BY_COMPLETION_ID)
     ...
     */
    @GET(OpenAiApiPaths.CHAT_BY_COMPLETIONS_BY_COMPLETION_ID_BY_MESSAGES)
