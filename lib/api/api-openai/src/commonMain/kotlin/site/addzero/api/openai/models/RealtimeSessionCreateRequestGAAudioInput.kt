...
@Serializable
data class RealtimeSessionCreateRequestGAAudioInput(
    /**
    ...
    val noiseReduction: site.addzero.api.openai.models.RealtimeSessionCreateRequestGAAudioInputNoiseReduction? = null,
