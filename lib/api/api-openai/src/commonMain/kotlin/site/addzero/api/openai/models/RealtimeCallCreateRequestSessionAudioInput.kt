...
@Serializable
data class RealtimeCallCreateRequestSessionAudioInput(
    /**
    ...
    val noiseReduction: site.addzero.api.openai.models.RealtimeCallCreateRequestSessionAudioInputNoiseReduction? = null,
