 ...
 */
@Serializable
data class CreateEvalCompletionsRunDataSource(
    /**
     * The type of run data source. Always `completions`.
     */
    val type: String = "completions",
    /**
    ...
    val samplingParams: site.addzero.api.openai.models.CreateEvalCompletionsRunDataSourceSamplingParams? = null,
    /**
