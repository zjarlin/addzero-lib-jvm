...
data class RealtimeResponseUsage(
    ...
    val inputTokenDetails: site.addzero.api.openai.models.RealtimeResponseUsageInputTokenDetails? = null,
    /**
     * Details about the output tokens used in the Response.
     */
    @SerialName("output_token_details")
    val outputTokenDetails: site.addzero.api.openai.models.RealtimeResponseUsageOutputTokenDetails? = null
)
