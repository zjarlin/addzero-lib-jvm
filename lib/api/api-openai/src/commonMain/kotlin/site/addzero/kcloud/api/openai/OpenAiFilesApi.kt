...
interface OpenAiFilesApi {
     ...
     */
    @DELETE(OpenAiApiPaths.FILES_BY_FILE_ID)
     ...
     */
    @GET(OpenAiApiPaths.FILES_BY_FILE_ID)
     ...
     */
    @GET(OpenAiApiPaths.FILES_BY_FILE_ID_BY_CONTENT)
