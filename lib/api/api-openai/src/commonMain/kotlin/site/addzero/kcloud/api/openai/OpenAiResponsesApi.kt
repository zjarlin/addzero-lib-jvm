...
interface OpenAiResponsesApi {
     ...
     */
    @POST(OpenAiApiPaths.RESPONSES_BY_COMPACT)
     ...
     */
    @POST(OpenAiApiPaths.RESPONSES_BY_INPUT_TOKENS)
     ...
     */
    @DELETE(OpenAiApiPaths.RESPONSES_BY_RESPONSE_ID)
     ...
     */
    @GET(OpenAiApiPaths.RESPONSES_BY_RESPONSE_ID)
     ...
     */
    @POST(OpenAiApiPaths.RESPONSES_BY_RESPONSE_ID_BY_CANCEL)
     ...
     */
    @GET(OpenAiApiPaths.RESPONSES_BY_RESPONSE_ID_BY_INPUT_ITEMS)
