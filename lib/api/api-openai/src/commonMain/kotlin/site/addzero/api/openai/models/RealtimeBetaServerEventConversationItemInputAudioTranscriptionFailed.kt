 ...
 */
@Serializable
data class RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailed(
    /**
     ...
     */
    val error: site.addzero.api.openai.models.RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailedError
)
