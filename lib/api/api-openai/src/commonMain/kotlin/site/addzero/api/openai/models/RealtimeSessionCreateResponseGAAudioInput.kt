...
@Serializable
data class RealtimeSessionCreateResponseGAAudioInput(
    /**
    ...
    val noiseReduction: site.addzero.api.openai.models.RealtimeSessionCreateResponseGAAudioInputNoiseReduction? = null,
