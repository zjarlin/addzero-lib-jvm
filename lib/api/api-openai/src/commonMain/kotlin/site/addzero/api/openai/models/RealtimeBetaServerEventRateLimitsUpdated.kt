 ...
 */
@Serializable
data class RealtimeBetaServerEventRateLimitsUpdated(
    /**
    ...
    val rateLimits: List<site.addzero.api.openai.models.RealtimeBetaServerEventRateLimitsUpdatedRateLimit>
)
