...
import com.addzero.processor.type.TypeMappingManager
    ...
    private fun extractTypeString(type: KSType): String {
        try {
            ...
            if (isJimmerEntity(declaration)) {
                ...
                return "com.addzero.generated.isomorphic.${entitySimpleName}Iso"
            }
    ...
    private fun convertRawTypeString(rawTypeString: String): String {
        ...
        return when {
            ...
            baseTypeName.endsWith("DTO") -> {
                ...
                "com.addzero.generated.isomorphic.${entityName}Iso"
            }
    ...
    private fun fallbackToCodeGenerator(controllerInfo: ControllerInfo, apiClassName: String) {
        try {
            ...
            file.use { outputStream ->
                val code = generateKtorfitCode(controllerInfo, apiClassName, "com.addzero.api")
                outputStream.write(code.toByteArray())
            }

            logger.info("Fallback: Generated Ktorfit interface to build directory: com.addzero.generated.api.$apiClassName")
        } catch (e: Exception) {
