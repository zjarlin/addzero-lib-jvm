...
interface KlAnnotated {}


interface KlClassDeclaration {}
...
interface KlResolver {
     ...
     */
    fun getFunctionDeclarationsByName(name: KlName, includeTopLevel: Boolean = false): Sequence<KSFunctionDeclaration>
     ...
     */
    fun getPropertyDeclarationByName(name: KlName, includeTopLevel: Boolean = false): KSPropertyDeclaration?
     ...
     * Calling [overrides] is expensive and should be avoided if possible.
     */
    fun overrides(overrider: KSDeclaration, overridee: KSDeclaration, containingClass: KlClassDeclaration): Boolean
