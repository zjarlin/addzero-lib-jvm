...
suspend fun ApplicationCall.receiveSpringMultipartParts(): SpringMultipartParts {
    val multipartData = receiveMultipart()
    return multipartData.toSpringMultipartParts()
}

suspend fun MultiPartData.toSpringMultipartParts(): SpringMultipartParts {
