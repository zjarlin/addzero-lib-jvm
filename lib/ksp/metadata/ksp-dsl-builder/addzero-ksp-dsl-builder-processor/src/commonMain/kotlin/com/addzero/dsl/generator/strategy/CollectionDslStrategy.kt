...
import com.addzero.dsl.generator.generateNestedClassImports
import com.addzero.dsl.generator.generatePluralDslFunctionName
 ...
 * 集合类型 DSL 生成策略
 */
class CollectionDslStrategy : DslStrategy {
    override fun support(meta: DslMeta): Boolean {
        ...
        // 1. 有泛型参数
        // 2. 是集合类型
        return hasTypeParams && isCollectionType
    }
