...
package com.addzero.processor.enum
...
class EnumProcessor(
    ...
    private fun generateEnumInfoClass(enumClasses: List<KSClassDeclaration>) {
        ...
        // 创建文件
        val fileSpec = FileSpec.builder("com.addzero.generated.enum", "EnumRegistry")
    ...
    companion object {
        private val ENUM_ENTRY_INFO = ClassName("com.addzero.generated.enum", "EnumEntryInfo")
        private val ENUM_INFO = ClassName("com.addzero.generated.enum", "EnumInfo")
