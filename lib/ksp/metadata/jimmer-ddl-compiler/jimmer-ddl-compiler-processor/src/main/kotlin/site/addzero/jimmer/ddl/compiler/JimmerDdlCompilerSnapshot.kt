...
private fun LsiType.snapshot(cache: MutableMap<String, LsiClass>): LsiType {
    return SnapshotLsiType(
        ...
        isCollectionType = isCollectionType,
        isNullable = isNullable,
        typeParameters = typeParameters.map { it.snapshot(cache) },
        isPrimitive = isPrimitive,
        componentType = componentType?.snapshot(cache),
        isArray = isArray,
        lsiClass = null,
    )
}
