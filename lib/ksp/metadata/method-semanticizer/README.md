...
// Generated by Method Semanticizer. DO NOT EDIT.
package site.addzero.vibepocket.api.netease
...
public suspend fun NeteaseApi.searchSongs(
  ...
  limit: Int,
  offset: Int,
): NeteaseSearchRes = search(s = s, type = site.addzero.vibepocket.api.netease.model.MusicSearchType.SONG.value, limit = limit, offset = offset)

/**
 * 搜索专辑
 */
public suspend fun NeteaseApi.searchAlbums(
  s: String,
  limit: Int,
  offset: Int,
): NeteaseSearchRes = search(s = s, type = site.addzero.vibepocket.api.netease.model.MusicSearchType.ALBUM.value, limit = limit, offset = offset)

/**
 * 搜索艺术家
 */
public suspend fun NeteaseApi.searchArtist(
  s: String,
  limit: Int,
  offset: Int,
): NeteaseSearchRes = search(s = s, type = site.addzero.vibepocket.api.netease.model.MusicSearchType.ARTIST.value, limit = limit, offset = offset)

/**
 * 搜索播放列表
 */
public suspend fun NeteaseApi.searchPlaylist(
  s: String,
  limit: Int,
  offset: Int,
): NeteaseSearchRes = search(s = s, type = site.addzero.vibepocket.api.netease.model.MusicSearchType.PLAYLIST.value, limit = limit, offset = offset)

/**
 * 搜索歌词
 */
public suspend fun NeteaseApi.searchLyric(
  s: String,
  limit: Int,
  offset: Int,
): NeteaseSearchRes = search(s = s, type = site.addzero.vibepocket.api.netease.model.MusicSearchType.LYRIC.value, limit = limit, offset = offset)
