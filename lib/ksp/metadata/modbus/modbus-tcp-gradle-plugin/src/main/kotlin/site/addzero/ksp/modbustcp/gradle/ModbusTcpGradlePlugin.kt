package site.addzero.ksp.modbustcp.gradle
...
class ModbusTcpGradlePlugin : AbstractPublishedKspConsumerPlugin() {
    ...
    override fun createExtension(project: Project): Any {
        return createTypedExtension(project, EXTENSION_NAME, ModbusTcpExtension::class.java)
    }

    override fun collectKspArgs(project: Project, extension: Any?): Map<String, String> {
        val modbus = extension as ModbusTcpExtension
