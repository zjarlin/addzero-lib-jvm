...
val generateRoutePluginCoordinates = tasks.register<WriteProperties>("generateRoutePluginCoordinates") {
    destinationFile = generatedCoordinatesDir
        .map { dir -> dir.file("site/addzero/ksp/route/gradle-plugin.properties") }
        .get()
        .asFile
    encoding = "UTF-8"
...
tasks.processResources {
    dependsOn(generateRoutePluginCoordinates)
