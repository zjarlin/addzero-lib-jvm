...
object BeanUtil {
    ...
    fun mapToBean(map: Map<String, String>): Settings = Settings(
        ...
        // 包名配置（小驼峰命名）
        isomorphicPackageName = map["isomorphicPackageName"] ?: "com.addzero.generated.isomorphic",
        formPackageName = map["formPackageName"] ?: "com.addzero.generated.forms",
        enumOutputPackage = map["enumOutputPackage"] ?: "com.addzero.generated.enums",
        apiClientPackageName = map["apiClientPackageName"] ?: "com.addzero.generated.api",
